...
namespace NEEDSIM
{
    ...
    public class NEEDSIMManagerInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                if (GUILayout.Button("Edit data for NEEDSIM Life simulation", EditorExtensionSettings.MediumEditorFieldWidth))
                {
        ...
        private void GeneralSettingsEditing()
        {
            EditorGUILayout.BeginVertical();
            {
                ...
                if (NEEDSIMManager.IsPaused)
                {
                    if (GUILayout.Button("Restart Simulation", EditorExtensionSettings.MediumEditorFieldWidth))
                    {
                        NEEDSIMManager.RestartSimulation();
                    }
                }
                else
                {
                    if (GUILayout.Button("Stop Simulation", EditorExtensionSettings.MediumEditorFieldWidth))
                    {
                        NEEDSIMManager.StopSimulation();
                    }
                }
