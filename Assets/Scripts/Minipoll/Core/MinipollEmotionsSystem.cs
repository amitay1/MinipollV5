...
namespace MinipollGame.Core
{
    ...
    public class MinipollEmotionsSystem : MonoBehaviour
    {
        ...
        /// </summary>
        private EmotionType MapExternalToLocalEmotion(Emotion externalEmotion)
        {
            switch (externalEmotion)
            {
                case Emotion.Happiness: return EmotionType.Happy;
                case Emotion.Sadness: return EmotionType.Sad;
                case Emotion.Anger: return EmotionType.Angry;
                case Emotion.Fear: return EmotionType.Afraid;
                case Emotion.Surprise: return EmotionType.Surprised;
                case Emotion.Disgust: return EmotionType.Disgusted;
                case Emotion.Trust: return EmotionType.Trusting;
                case Emotion.Love: return EmotionType.Loving;
                case Emotion.Excitement: return EmotionType.Excited;
                case Emotion.Wonder: return EmotionType.Curious;
                case Emotion.Anxiety: return EmotionType.Scared;
                case Emotion.Shame: return EmotionType.Embarrassed;
        ...
        internal void ChangeEmotion(object emotionObj, float intensity)
        {
            ...
            else if (emotionObj is Emotion externalEmotion)
            {
        ...
        internal void ChangeEmotionEnum(Emotion externalEmotion, float intensity)
        {
            EmotionType mappedEmotion = MapExternalToLocalEmotion(externalEmotion);
            AddEmotion(mappedEmotion, intensity);
        }
